...
namespace Backend.Migrations
{
    ...
    [Migration("20220317103344_ImagePathToPostModel")]
    partial class ImagePathToPostModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Follow", b =>
                {
                    ...
                    b.HasOne("Backend.Models.AppUser", "Followee")
                        .WithMany("Follower")
            ...
            modelBuilder.Entity("Backend.Models.Post", b =>
                {
                    b.HasOne("Backend.Models.AppUser", "PostBy")
                        .WithMany("Posts")
